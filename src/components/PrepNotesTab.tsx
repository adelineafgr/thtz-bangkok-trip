...
export const PrepNotesTab: React.FC = () => {
  ...
  return (
    <div className="space-y-6 pb-20">
      ...
      {/* Filter Dropdown & Summary Counters */}
      <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3">
        {/* Status Dropdown */}
        <div className="flex items-center space-x-2 bg-white px-3.5 py-2 rounded-2xl border border-indigo-100 shadow-2xs text-xs self-start sm:self-auto">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-1.5 sm:gap-3 bg-white px-4 py-2 rounded-2xl border border-indigo-100 shadow-2xs">
          <div className="flex items-center space-x-2 text-xs font-bold text-indigo-600">
            <span className="text-emerald-700 font-black">{doneCount} Done</span>
            <span className="text-indigo-200">•</span>
            <span className="text-amber-700 font-black">{upcomingCount} Upcoming</span>
            <span className="text-indigo-200">•</span>
            <span className="text-sky-700 font-black">{scheduleCount} To Schedule</span>
          </div>
          <span className="hidden sm:inline text-indigo-200">•</span>
          <span className="text-[11px] font-black text-emerald-600">
            {doneCount > 0 && doneCount === prepNotes.length ? 'We are ready for Bangkok 🎉' : 'Getting Ready for Bangkok'}
          </span>
        </div>
      </div>
